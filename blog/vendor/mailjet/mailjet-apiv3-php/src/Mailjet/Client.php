...
class Client
{
     ...
     * @param string $key Mail API Key
     * @param string|null $secret Mail API Secret
     ...
     * @param array $resource Mail Resource/Action pair
     ...
     * @param string $resource Mail resource
     * @param string $action Mail resource action
