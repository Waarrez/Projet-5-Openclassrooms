...
$body = [
    'Messages' => [
        [
            ...
            'Subject' => "My first Mail Email!",
            'TextPart' => "Greetings from Mail!",
            'HTMLPart' => "<h3>Dear passenger 1, welcome to <a href=\"https://www.mailjet.com/\">Mail</a>!</h3>
...
$body = [
    'Text' => "Have a nice SMS flight with Mail !",
    'To' => "+336000000000",
    'From' => "MJ Pilot",
];
